...
async function seed() {
  ...
  await client.createOrReplace({
    ...
    usps: [
      { _key: 'u1', title: 'Individuell', description: 'Jedes Konzept wird exakt auf Ihre Gegebenheiten abgestimmt. Denn eine Investition, die langfristig überzeugen soll, verdient eine Lösung, die von Grund auf zu Ihnen passt.', iconSvg: '<path d="M13.4 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7.4"/><path d="M2 6h4"/><path d="M2 10h4"/><path d="M2 14h4"/><path d="M2 18h4"/><path d="M21.378 5.626a1 1 0 1 0-3.004-3.004l-5.01 5.012a2 2 0 0 0-.506.854l-.837 2.87a.5.5 0 0 0 .62.62l2.87-.837a2 2 0 0 0 .854-.506z"/>' },
      ...
      { _key: 'u3', title: 'Aus einer Hand', description: 'Planung, Koordination und Umsetzung aller Gewerke übernehmen wir vollständig. Sie behalten den Überblick, ohne sich um jedes Detail kümmern zu müssen.', iconSvg: '<path d="M11 12h2a2 2 0 1 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 14"/><path d="m7 18 1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2l4.6-4.4a2 2 0 0 0-2.75-2.91l-4.2 3.9"/><path d="m2 13 6 6"/>' },
      { _key: 'u4', title: 'Persönlich', description: 'Eine Fachperson, ein Projekt, ein Draht. Sie rufen an, wir wissen Bescheid.', iconSvg: '<path d="m11 17 2 2a1 1 0 1 0 3-3"/><path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4"/><path d="m21 3 1 11h-2"/><path d="M3 3 2 14l6.5 6.5a1 1 0 1 0 3-3"/><path d="M3 4h8"/>' },
    ],
    closingText: [
