...
- **Cowork-Mount-Drift:** Beim Schreiben grosser Dateien über das
  Edit/Write-Tool kann die Datei auf der Linux-Seite truncated ankommen,
  obwohl das Tool "Success" zurückgibt. Bei jedem grösseren Write via
  `wc -l` auf dem Linux-Mount prüfen. Wenn truncated:
  ```bash
