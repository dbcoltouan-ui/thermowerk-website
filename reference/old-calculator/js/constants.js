// Referenz-Konstanten aus FWS Modul 3 (1-2025) / SIA 384/1:2022 / SIA 385/1:2020 / SIA 385/2
// Alle Werte editierbar als Default-Vorlage

export const BRENNWERTE = {
...
export const SPEZ_HEIZLEISTUNG = [
...
export const SANIERUNGS_MASSNAHMEN = [
...
export const BIVALENZ = [
  { wpAnteil: 0.50, energieanteil: [80, 85] },
  { wpAnteil: 0.33, energieanteil: [50, 60] },
  { wpAnteil: 0.25, energieanteil: [30, 40] },
];

// Heizpuffer / Pufferspeicher (nicht FWS, Quellen: SWKI BT 102-01, VDI 4645, WP-Herstellerhandbücher)
// Richtwerte je nach WP-Typ und Einsatzgrund. Tool nimmt das Maximum der zutreffenden Kriterien.
export const HEIZPUFFER = {
  // Physik
  cp:             4.2,   // kJ/(kg·K)
  // (1) Abtauung L/W-WP: t_Abtau · ΔT_zul
  abtauZeitMin:   5,     // min typische Dauer Prozessumkehr
  abtauDeltaT:    5,     // K zulässige Systemtemperatur-Absenkung
  // (2) Mindestlaufzeit Kompressor
  taktZeitMin:    6,     // min typische Mindestlaufzeit Scrollverdichter
