...
### Phasen 4–7 (offen)
Phase 4 (Sektionen 1–7 auf Basis der Primitives + State), Phase 5 (Executive Summary + Chart.js-Diagramm), Phase 6 (Login-Modal + PDF-Export), Phase 7 (Testing + Deploy) — siehe `HANDOFF-PHASE-4.md`.
